...
export default function ServicesCustomErpSolutions() {
  ...
  return (
    ...
    <article className="pg_service">
      <ServicesBanner data="BharathaTechno – Expert Providers of Custom ERP Solutions Tailored to Your Needs"/>
      <ServicesList />
      <Summary>
        <motion.h2
          ref={ref2}
        ...
        >
            At BharathaTechno, we specialize in developing tailored Enterprise
            Resource Planning (ERP) solutions that align perfectly with your
            unique business processes and goals. Our custom ERP development
            services are designed to enhance your operational efficiency,
            streamline workflows, and drive growth.
        </motion.p>
      </Summary>
      <Technology title="Technologies We Use" tech={SERVICE_CUSTOM_ERP} />
      <DetailsAccordion items={SERVICE_CUSTOM_ERP_DETAILS} />
      <ServicesFeatures data={SERVICE_CUSTOM_ERP_FEATURES} />
      <ServicesContact
        title="Our Commitment to Quality"
        description="Transform your business operations with a custom ERP solution from BharathaTechno. Contact us today to start your journey towards enhanced efficiency and growth."
      />
    </article>
    </>
  );
