...
const images = [
  "/images/gallery/r3constructor-about.webp",
  "/images/gallery/r3constructor-gallery.webp",
  "/images/gallery/r3constructor-operate.webp",
  "/images/gallery/r3constructor-workt.webp",
];
