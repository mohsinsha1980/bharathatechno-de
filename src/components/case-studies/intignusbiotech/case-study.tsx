...
import IntignusBiotechContent from "./content";
import IntignusBiotechImage from "./image";
import useScreenSize from "@/hooks/useScreenSize";
import { easeOut } from "popmotion";

export default function IntignusBiotech() {
