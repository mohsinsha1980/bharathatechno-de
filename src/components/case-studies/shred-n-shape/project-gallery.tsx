...
const images = [
  "/images/gallery/shred-n-shape-gallery.webp",
  "/images/gallery/shred-n-shape-gallery-events.webp",
  "/images/gallery/shred-n-shape-gallery-program-detail.webp",
  "/images/gallery/shred-n-shape-gallery-programs.webp",
];
