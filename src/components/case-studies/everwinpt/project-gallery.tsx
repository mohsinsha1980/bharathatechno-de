...
const images = [
  "/images/gallery/everwinpt-gallery.webp",
  "/images/gallery/everwinpt-gallery-ground.webp",
  "/images/gallery/everwinpt-gallery-home.webp",
  "/images/gallery/everwinpt-gallery-post-work.webp",
];
