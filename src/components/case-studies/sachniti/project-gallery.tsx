...
const images = [
  "/images/gallery/sachniti-gallery.webp",
  "/images/gallery/sachniti-gallery-product-list.webp",
  "/images/gallery/sachniti-gallery-products.webp",
  "/images/gallery/sachniti-gallery-rotary.webp",
];
