...
const images = [
  "/images/gallery/trendy-threads-gallery.webp",
  "/images/gallery/trendy-threads-gallery-trendy-products.webp",
  "/images/gallery/trendy-threads-gallery-western-wear.webp",
  "/images/gallery/trendy-threads-gallery-women.webp",
];
